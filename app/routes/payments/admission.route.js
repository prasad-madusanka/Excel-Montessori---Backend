...
module.exports = (app) => {
    ...
    app.put('/excel/payments/admission', admissionController.pullAdmissionPayment)
    app.put('/excel/payments/admission/status', admissionController.updateSettlementStatus)
